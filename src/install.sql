...
CREATE TABLE IF NOT EXISTS `wa20260315_admin_account_role` (
...
CREATE TABLE IF NOT EXISTS `wa20260315_admin_account` (
...
CREATE TABLE IF NOT EXISTS `wa20260315_options` (
...
LOCK TABLES `wa20260315_options` WRITE;
INSERT INTO `wa20260315_options`
VALUES (1, 'system_config',
       ...
       (4, 'table_form_schema_wa20260315_admin_rule',
       ...
       (5, 'table_form_schema_wa20260315_admin_account',
       ...
       (6, 'table_form_schema_wa20260315_options',
       ...
       (7, 'table_form_schema_wa20260315_uploads',
       ...
       (11, 'table_form_schema_wa20260315_admin_account_role',
...
INSERT INTO `wa20260315_admin_role` VALUES (1,'超级管理员','*','2022-08-13 16:15:01','2022-12-23 12:05:07',NULL);
UNLOCK TABLES;

CREATE TABLE IF NOT EXISTS `wa20260315_admin_rule` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `wa20260315_uploads` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `wa20260315_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `username` varchar(32) NOT NULL COMMENT '用户名',
  `nickname` varchar(40) NOT NULL COMMENT '昵称',
  `password` varchar(255) NOT NULL COMMENT '密码',
